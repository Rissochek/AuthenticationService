...
const (
	Auth_GetTokens_FullMethodName     = "/proto.Auth/GetTokens"
	Auth_RefreshTokens_FullMethodName = "/proto.Auth/RefreshTokens"
	Auth_GetGUID_FullMethodName       = "/proto.Auth/GetGUID"
	Auth_Logout_FullMethodName        = "/proto.Auth/Logout"
	Auth_AddUser_FullMethodName       = "/proto.Auth/AddUser"
)
...
type AuthClient interface {
	...
	AddUser(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*AddUserReply, error)
}
...
func (c *authClient) GetTokens(ctx context.Context, in *GetTokensMsg, opts ...grpc.CallOption) (*GetTokensReply, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetTokensReply)
	err := c.cc.Invoke(ctx, Auth_GetTokens_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *authClient) RefreshTokens(ctx context.Context, in *RefreshTokensMsg, opts ...grpc.CallOption) (*RefreshTokensReply, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (c *authClient) AddUser(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*AddUserReply, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type AuthServer interface {
	...
	AddUser(context.Context, *emptypb.Empty) (*AddUserReply, error)
...
func (UnimplementedAuthServer) GetTokens(context.Context, *GetTokensMsg) (*GetTokensReply, error) {
...
func (UnimplementedAuthServer) AddUser(context.Context, *emptypb.Empty) (*AddUserReply, error) {
...
func _Auth_GetTokens_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetTokensMsg)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AuthServer).GetTokens(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Auth_GetTokens_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthServer).GetTokens(ctx, req.(*GetTokensMsg))
	}
...
func _Auth_RefreshTokens_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthServer).RefreshTokens(ctx, req.(*RefreshTokensMsg))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _Auth_GetGUID_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	if interceptor == nil {
		return srv.(AuthServer).GetGUID(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
...
func _Auth_AddUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthServer).AddUser(ctx, req.(*emptypb.Empty))
	}
	return interceptor(ctx, in, info, handler)
}
