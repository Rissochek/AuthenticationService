...
# Запуск проекта
1. `git clone https://github.com/Rissochek/AuthenticationService.git .` (если уже создали папку для проекта). `git clone https://github.com/Rissochek/AuthenticationService.git` (если не создали папку для проекта)
